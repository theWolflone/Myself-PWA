  ...
  for (var i = 0; i < inputs.length; i++) {
    if (inputs[i].required == true) {
      ...
      if (
        ...
        ImprimirMsjError("Ingrese lo que se le solicita");
      ...
      if (inputs[i].type.toLowerCase() == "date") {
        if (
          ...
          ImprimirMsjError('Ingrese una fecha.');
          return false;
        }
      }
  ...
  for (var i = 0; i < selects.length; i++) {
    if (selects[i].required == true) {
      if (
        ...
        ImprimirMsjError("Seleccione un valor");
  ...
  for (var i = 0; i < textAreas.length; i++) {
    if (textAreas[i].required == true) {
      if (
        ...
        ImprimirMsjError("Ingrese una descripción.");
        return false;
      }
    }
  }
