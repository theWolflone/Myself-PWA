...
function notas() {
  Swal.fire({
    title:
      '<h2 style="color: #20997B; font-family: Quicksand;; text-align: left; font-size: 3vh; margin: 0;">NOTAS</h2>',
    background: "#F0FFE2",
    html:
...
function medicacion() {
  Swal.fire({
    title:
      '<h2 style="color: #20997B; text-align: left; font-size: 3vh; margin: 0; font-family: Quicksand;">AÑADIR MEDICACIÓN</h2>',
    background: "#F0FFE2",
    html:
      "<br>" +
      '<label style="color: #1F4650; font-family: Montserrat Normal; font-weight: bold; font-size: 2.4vh;" >Nombre del medicamento</label>' +
      '<input id="nombreMedicamento" type="text" required style=" font-family: Montserrat Normal; width: 60vw; height: 3.5vh; border-radius: 5px; background: #FEFDF9; border: none; box-shadow: 2px 3px 4px rgba(0, 0, 0, 0.25); border-radius: 5px; margin-top: 1vh; padding-left: 2vw; font-size: 1.9vh;"></input>' +
      ...
      "<br>" +
      '<input id="tCada" type="number" required min="1" style=" text-align: left; font-family: Montserrat Normal; margin-top:.5vh; width: 23vw; height: 3.5vh; border-radius: 5px; background: #FEFDF9; border: none; box-shadow: 2px 3px 4px rgba(0, 0, 0, 0.25); border-radius: 5px; padding-left: 2vw; font-size: 1.9vh;"></input>' +
      ...
      "<br>" +
      '<input id="tDurante" type="number" required min="1" style=" font-family: Montserrat Normal; margin-top:.5vh; width: 23vw; height: 3.5vh; border-radius: 5px; background: #FEFDF9; border: none; box-shadow: 2px 3px 4px rgba(0, 0, 0, 0.25); border-radius: 5px; padding-left: 2vw; font-size: 1.9vh;"></input>' +
      ...
      "<br>" +
      '<input id="fechaInicio" type="date" required style=" font-family: Montserrat Normal; margin-top:.5vh; text-align: center; width: 40vw; height: 3.5vh; border-radius: 5px; background: #FEFDF9; border: none; box-shadow: 2px 3px 4px rgba(0, 0, 0, 0.25); border-radius: 5px; padding-left: 2vw; font-size: 1.9vh;"></input>' +
      "</div>" +
      '<button onclick="ValidacionesMedicacion()" style="width: 40vw; font-family: Montserrat Normal; height:8vh; background-color: #1F4650; border-radius: 20px; margin-top: 2vh"; >' +
      '<h3 style="color: #FFFFE3; font-size: 2.2vh;">Guardar</h3>' +
      "</button>",
    focusConfirm: false,
    showCancelButton: false,
...
function recordatorio() {
  Swal.fire({
    title:
      '<h2 style="color: #20997B; text-align: left; font-size: 2.5vh; margin: 0; font-family: Quicksand;">AÑADIR RECORDATORIO</h2>',
    background: "#F0FFE2",
    html:
      "<br>" +
      ...
      '<input id="nombreRecordatorio" type="text" required style="font-family: Montserrat Normal; width: 76vw; height: 3.5vh; border-radius: 5px; background: #FEFDF9; border: none; box-shadow: 2px 3px 4px rgba(0, 0, 0, 0.25); border-radius: 5px; margin-top: 1vh; padding-left: 2vw; font-size: 1.9vh;"></input>' +
      '<textarea id="descripcionRecordatorio" wrap="soft" style="resize: none; width: 70vw; height: 15vh; border: none; border-radius: 15px; padding: 4vw; margin:auto; margin-top: 2vh; box-shadow: 3px 3px 4px rgba(0, 0, 0, 0.25); background: #FFFEF4; font-size: 1.9vh; font-family:Montserrat Normal;" placeholder="Descripción..."></textarea>' +
      ...
      "<br>" +
      '<input id="fechaRecordatorio" type="date" required style="font-family: Montserrat Normal; margin-top:.5vh; text-align: left; width: 40vw; height: 3.5vh; border-radius: 5px; background: #FEFDF9; border: none; box-shadow: 2px 3px 4px rgba(0, 0, 0, 0.25); border-radius: 5px; padding-left: 2vw; font-size: 1.9vh;"></input>' +
      "</div>" +
      '<div style="text-align: center;">' +
      '<button onclick="ValidacionesRecordatorios()" style="width: 40vw; font-family: Montserrat Normal; height:8vh; background-color: #1F4650; border-radius: 20px; margin-top: 2vh"; >' +
      '<h3 style="color: #FFFFE3; font-size: 2.2vh;">Guardar</h3>' +
      "</button>",
    focusConfirm: false,
    showCancelButton: false,
...
(function () {
  ...
  function supersad() {
    ...
    return faces = [face1.value, face2.value, face3.value, face4.value, face5.value];
  }
  function sad() {
    face1.addEventListener("click", supersad);
    face2.addEventListener("click", sad);
